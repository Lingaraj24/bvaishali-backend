  ...
  const campaigns = await Promise.all([
    prisma.campaign.upsert({
      ...
      create: {
        ...
        heading: "Woven in tradition.\nWorn with intention.",
        subHeading: "Designer dresses rooted in Sambalpuri craft.\nMade for women who carry stories.",
        description: 'Warm terracotta and ochre tones for the spring summer season. Handwoven Sambalpuri ikat meets natural dye.',
        heroR2Key: "campaigns/ss26-hero.jpg",
        subImage1R2Key: "campaigns/ss26-sub1.jpg",
        subImage2R2Key: "campaigns/ss26-sub2.jpg",
        isActive: true,
    ...
    prisma.campaign.upsert({
      where: { slug: 'earth-and-thread' },
      update: {},
      create: {
        title: 'Earth & Thread',
        slug: 'earth-and-thread',
        tagline: 'Latest Campaign',
        heading: 'Earth & Thread',
        description: 'Shot in the red soil villages of Sambalpur. A collection that asks: what does it mean to dress in something that took two hands and forty years of craft to make?',
        heroR2Key: "https://images.unsplash.com/photo-1610030469983-98e550d6193c?w=700&q=80&auto=format&fit=crop",
        subImage1R2Key: "https://images.unsplash.com/photo-1583391733956-62e6ab0d77de?w=400&q=80&auto=format&fit=crop",
        subImage2R2Key: "https://images.unsplash.com/photo-1558769132-cb1aea458c5e?w=400&q=80&auto=format&fit=crop",
        isActive: true,
